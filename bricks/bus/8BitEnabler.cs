datablock fxDTSBrickData(LogicGate__8BitEnabler_Data)
{
	brickFile = "Add-Ons/Brick_Illogic/bricks/blb/8BitEnabler.blb";
...
function LogicGate__8BitEnabler_Data::doLogic(%this, %obj)
{
	...
	else
	{
		...
		%obj.Logic_SetOutput(15, 0);
		%obj.Logic_SetOutput(14, 0);
