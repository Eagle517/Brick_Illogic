datablock fxDTSBrickData(LogicGate__3BitDFlipFlop_Data)
{
	brickFile = "Add-Ons/Brick_Illogic/bricks/blb/3BitDFlipFlop.blb";
	category = "Logic Bricks";
	subCategory = "Bus";
	uiName = "3 Bit D FlipFlop";
	iconName = "";
	hasPrint = 1;
	...
	logicUIName = "3 Bit D FlipFlop";
	logicUIDesc = "3 bit d flipflop with clock propagate";
	...
	logicPortDir[6] = 2;
	logicPortUIName[6] = "ClockIn";

	logicPortType[7] = 0;
	logicPortPos[7] = "-2 0 0";
	logicPortDir[7] = 0;
	logicPortUIName[7] = "ClockOut";
};

function LogicGate__3BitDFlipFlop_Data::doLogic(%this, %obj)
{
