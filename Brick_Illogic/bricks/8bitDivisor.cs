datablock fxDTSBrickData(LogicGate__8bitDivisor_Data)
{
	brickFile = "Add-Ons/Brick_Illogic/bricks/blb/8bitDivisor.blb";
...
function LogicGate__8bitDivisor_Data::doLogic(%this, %obj)
{
	%a =
	...
	if(%b)
	{
		...
		%obj.Logic_SetOutput(16, %quotient & 1);
		%obj.Logic_SetOutput(17, %quotient & 2);
		%obj.Logic_SetOutput(18, %quotient & 4);
		%obj.Logic_SetOutput(19, %quotient & 8);
		%obj.Logic_SetOutput(20, %quotient & 16);
		%obj.Logic_SetOutput(21, %quotient & 32);
		%obj.Logic_SetOutput(22, %quotient & 64);
		%obj.Logic_SetOutput(23, %quotient & 128);

		%obj.Logic_SetOutput(24, %remainder & 1);
		%obj.Logic_SetOutput(25, %remainder & 2);
		%obj.Logic_SetOutput(26, %remainder & 4);
		%obj.Logic_SetOutput(27, %remainder & 8);
		%obj.Logic_SetOutput(28, %remainder & 16);
		%obj.Logic_SetOutput(29, %remainder & 32);
		%obj.Logic_SetOutput(30, %remainder & 64);
		%obj.Logic_SetOutput(31, %remainder & 128);
	}
	else
	{
		...
		%obj.Logic_SetOutput(20, 0);
		%obj.Logic_SetOutput(21, 0);
		%obj.Logic_SetOutput(22, 0);
		%obj.Logic_SetOutput(23, 0);

		%obj.Logic_SetOutput(24, 0);
		%obj.Logic_SetOutput(25, 0);
		%obj.Logic_SetOutput(26, 0);
		%obj.Logic_SetOutput(27, 0);
		%obj.Logic_SetOutput(28, 0);
		%obj.Logic_SetOutput(29, 0);
		%obj.Logic_SetOutput(30, 0);
		%obj.Logic_SetOutput(31, 0);
	}
}